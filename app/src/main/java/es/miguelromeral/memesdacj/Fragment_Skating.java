...
/**
 * Clase para crear el fragment Skating.
 */
public class Fragment_Skating extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // Set title bar
        ((MainActivity) getActivity()).setActionBarTitle(getString(R.string.navigation_skating));

        return inflater.inflate(R.layout.fragment_skating, container, false);
    }
