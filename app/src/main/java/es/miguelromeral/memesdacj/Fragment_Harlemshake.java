...
/**
 * Clase para crear el fragment Harlem Shake.
 */
public class Fragment_Harlemshake extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // Set title bar
        ((MainActivity) getActivity()).setActionBarTitle(getString(R.string.navigation_harlemshake));

        return inflater.inflate(R.layout.fragment_harlemshake, container, false);
    }
}
